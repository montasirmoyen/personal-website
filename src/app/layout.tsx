...
export const metadata: Metadata = {
  ...
  title: "Montasir Moyen - Software Engineer | Full-Stack Developer - Boston",
  description: "A Software Engineer building web apps, AI integrations, and games. Based in Boston, MA, studying Computer Science at Suffolk University. Explore my projects in React, TypeScript, and more.",
  keywords: [
    "Montasir Moyen",
    "Montasir",
    "Moyen",
