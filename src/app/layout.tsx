...
export const metadata: Metadata = {
  ...
  title: "Montasir Moyen - Full-Stack Software Developer & Engineer in Boston",
  description: "Full-stack developer & engineer building web apps, AI integrations, and games. Based in Boston, MA, studying Computer Science at Suffolk University. Explore my projects in React, TypeScript, and more.",
  keywords: [
    "Montasir Moyen",
    "Montasir",
    "Moyen",
  ...
  openGraph: {
    title: "Montasir Moyen - Full-Stack Software Developer & Engineer",
    description: "Full-stack developer & engineer building web apps, AI integrations, and games. Based in Boston, MA, studying Computer Science at Suffolk University. Explore my projects in React, TypeScript, and more.",
...
export function JsonLd() {
  const schema = {
    ...
    jobTitle: "Full-Stack Software Developer & Engineer",
    worksFor: {
      "@type": "Organization",
      name: "Self-employed",
    },
