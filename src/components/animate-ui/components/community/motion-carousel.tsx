...
function MotionCarousel(props: PropType) {
  const { slides, options } = props; // slides are images
  ...
  return (
    <div className="w-full space-y-4 [--slide-height:9rem] sm:[--slide-height:13rem] md:[--slide-height:23rem] [--slide-spacing:1.5rem] [--slide-size:75%]">
        ...
        <div className="flex touch-pan-y touch-pinch-zoom">
          {slides.map((image, index) => {
            ...
            return (
              ...
              >
                <motion.div
                  className="relative size-full overflow-hidden flex items-center justify-center text-3xl md:text-5xl font-semibold select-none border-4 rounded-xl"
                  initial={false}
                  animate={{
                ...
                >
                  <Image
                    ...
                    alt={`Slide ${index + 1}`}
                    fill
                    sizes="(max-width: 640px) 55vw, (max-width: 768px) 55vw, 55vw"
